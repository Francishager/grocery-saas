...
// List employees
router.get("/", authenticateToken, requireFeature("hr"), async (req, res) => {
  try {
...
// Create employee
router.post("/", authenticateToken, requireFeature("hr"), async (req, res) => {
  try {
...
// Update employee
router.put("/:id", authenticateToken, requireFeature("hr"), async (req, res) => {
  try {
...
// Delete employee
router.delete("/:id", authenticateToken, requireFeature("hr"), async (req, res) => {
  try {
...
// Attendance
router.get("/:id/attendance", authenticateToken, requireFeature("hr"), async (req, res) => {
  try {
...
router.post("/:id/attendance", authenticateToken, requireFeature("hr"), async (req, res) => {
  try {
...
// Leave requests
router.get("/leave-requests", authenticateToken, requireFeature("hr"), async (req, res) => {
  try {
    const tenantId = req.user.tenantId || req.user.tenant_id;
...
router.post("/:id/leave", authenticateToken, requireFeature("hr"), async (req, res) => {
  try {
...
router.put("/leave-requests/:id", authenticateToken, requireFeature("hr"), async (req, res) => {
  try {
...
// Payroll
router.get("/payroll", authenticateToken, requireFeature("hr"), async (req, res) => {
  try {
    const tenantId = req.user.tenantId || req.user.tenant_id;
...
router.post("/payroll/run", authenticateToken, requireFeature("hr"), async (req, res) => {
  try {
    const tenantId = req.user.tenantId || req.user.tenant_id;
...
router.put("/payroll/:id/pay", authenticateToken, requireFeature("hr"), async (req, res) => {
  try {
