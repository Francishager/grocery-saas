...
async function main() {
  ...
  const categories = [
    ...
    { name: "Laundry & Fabric Care", slug: "laundry-fabric-care" },
    ...
    { name: "Disposable Products", slug: "disposable-products" },
    { name: "Clothing", slug: "clothing" },
    { name: "Footwear & Clothing", slug: "footwear-clothing" },
    { name: "Toys & Gifts", slug: "toys-gifts" },
    { name: "Batteries & Electrical", slug: "batteries-electrical" },
