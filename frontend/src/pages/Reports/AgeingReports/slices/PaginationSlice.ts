...
const ageingReportsPaginationSlice = createSlice({
  name: 'ageingReportsPagination',
  initialState,
  reducers: {
...
export const {
  ...
  lastPage,
  reset,
} = ageingReportsPaginationSlice.actions

export default ageingReportsPaginationSlice.reducer
