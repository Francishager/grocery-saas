...
const payablesDisbursementPaginationSlice = createSlice({
  name: 'payablesDisbursementPagination',
  initialState,
  reducers: {
...
export const {
  ...
  lastPage,
  reset,
} = payablesDisbursementPaginationSlice.actions

export default payablesDisbursementPaginationSlice.reducer
