...
const incomeStatementPaginationSlice = createSlice({
  name: 'incomeStatementPagination',
  initialState,
  reducers: {
...
export const {
  ...
  lastPage,
  reset,
} = incomeStatementPaginationSlice.actions

export default incomeStatementPaginationSlice.reducer
