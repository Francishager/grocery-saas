...
const payablesArrearsPaginationSlice = createSlice({
  name: 'payablesArrearsPagination',
  initialState,
  reducers: {
...
export const {
  ...
  lastPage,
  reset,
} = payablesArrearsPaginationSlice.actions

export default payablesArrearsPaginationSlice.reducer
