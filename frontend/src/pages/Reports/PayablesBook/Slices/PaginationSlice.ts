...
const payablesBookPaginationSlice = createSlice({
  name: 'payablesBookPagination',
  initialState,
  reducers: {
...
export const {
  ...
  lastPage,
  reset,
} = payablesBookPaginationSlice.actions

export default payablesBookPaginationSlice.reducer
