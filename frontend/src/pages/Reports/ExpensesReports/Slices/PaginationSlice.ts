...
const expensesReportsPaginationSlice = createSlice({
  name: 'expensesReportsPagination',
  initialState,
  reducers: {
...
export const {
  ...
  lastPage,
  reset,
} = expensesReportsPaginationSlice.actions

export default expensesReportsPaginationSlice.reducer
