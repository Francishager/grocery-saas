...
const expectedPayablesSummaryReportPaginationSlice = createSlice({
  name: 'expectedPayablesSummaryReportPagination',
  initialState,
  reducers: {
...
export const {
  ...
  lastPage,
  reset,
} = expectedPayablesSummaryReportPaginationSlice.actions

export default expectedPayablesSummaryReportPaginationSlice.reducer
