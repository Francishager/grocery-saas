...
const expectedRecievablesRepaymentPaginationSlice = createSlice({
  name: 'expectedRecievablesRepaymentPagination',
  initialState,
  reducers: {
...
export const {
  ...
  lastPage,
  reset,
} = expectedRecievablesRepaymentPaginationSlice.actions

export default expectedRecievablesRepaymentPaginationSlice.reducer
