...
const groceryOfficerReportPaginationSlice = createSlice({
  name: 'groceryOfficerReportPagination',
  initialState,
  reducers: {
...
export const {
  ...
  lastPage,
  reset,
} = groceryOfficerReportPaginationSlice.actions

export default groceryOfficerReportPaginationSlice.reducer
