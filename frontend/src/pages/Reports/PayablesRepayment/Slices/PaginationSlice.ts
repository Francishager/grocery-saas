...
const payablesRepaymentPaginationSlice = createSlice({
  name: 'payablesRepaymentPagination',
  initialState,
  reducers: {
...
export const {
  ...
  lastPage,
  reset,
} = payablesRepaymentPaginationSlice.actions

export default payablesRepaymentPaginationSlice.reducer
