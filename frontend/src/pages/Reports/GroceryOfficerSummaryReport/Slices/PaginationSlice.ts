...
const groceryOfficerSummaryReportPaginationSlice = createSlice({
  name: 'groceryOfficerSummaryReportPagination',
  initialState,
  reducers: {
...
export const {
  ...
  lastPage,
  reset,
} = groceryOfficerSummaryReportPaginationSlice.actions

export default groceryOfficerSummaryReportPaginationSlice.reducer
