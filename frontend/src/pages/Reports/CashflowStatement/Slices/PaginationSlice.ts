...
const cashflowStatementPaginationSlice = createSlice({
  name: 'cashflowStatementPagination',
  initialState,
  reducers: {
...
export const {
  ...
  lastPage,
  reset,
} = cashflowStatementPaginationSlice.actions

export default cashflowStatementPaginationSlice.reducer
