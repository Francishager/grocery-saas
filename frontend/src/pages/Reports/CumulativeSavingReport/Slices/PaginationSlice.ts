...
const cumulativeSavingReportPaginationSlice = createSlice({
  name: 'cumulativeSavingReportPagination',
  initialState,
  reducers: {
...
export const {
  ...
  lastPage,
  reset,
} = cumulativeSavingReportPaginationSlice.actions

export default cumulativeSavingReportPaginationSlice.reducer
