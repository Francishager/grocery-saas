...
const balanceSheetPaginationSlice = createSlice({
  name: 'balanceSheetPagination',
  initialState,
  reducers: {
...
export const {
  ...
  lastPage,
  reset,
} = balanceSheetPaginationSlice.actions

export default balanceSheetPaginationSlice.reducer
