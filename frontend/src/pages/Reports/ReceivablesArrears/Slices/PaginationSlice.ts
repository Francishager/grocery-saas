...
const receivablesArrearsPaginationSlice = createSlice({
  name: 'receivablesArrearsPagination',
  initialState,
  reducers: {
...
export const {
  ...
  lastPage,
  reset,
} = receivablesArrearsPaginationSlice.actions

export default receivablesArrearsPaginationSlice.reducer
