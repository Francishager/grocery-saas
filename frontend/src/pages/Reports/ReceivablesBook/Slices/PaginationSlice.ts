...
const receivablesBookPaginationSlice = createSlice({
  name: 'receivablesBookPagination',
  initialState,
  reducers: {
...
export const {
  ...
  lastPage,
  reset,
} = receivablesBookPaginationSlice.actions

export default receivablesBookPaginationSlice.reducer
