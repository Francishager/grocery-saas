...
const clientReportPaginationSlice = createSlice({
  name: 'clientReportPagination',
  initialState,
  reducers: {
...
export const {
  ...
  lastPage,
  reset,
} = clientReportPaginationSlice.actions

export default clientReportPaginationSlice.reducer
