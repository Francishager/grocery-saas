...
const expectedRecievablesSummaryReportPaginationSlice = createSlice({
  name: 'expectedRecievablesSummaryReportPagination',
  initialState,
  reducers: {
...
export const {
  ...
  lastPage,
  reset,
} = expectedRecievablesSummaryReportPaginationSlice.actions

export default expectedRecievablesSummaryReportPaginationSlice.reducer
