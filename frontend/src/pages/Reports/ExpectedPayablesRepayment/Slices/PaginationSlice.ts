...
const expectedPayablesRepaymentPaginationSlice = createSlice({
  name: 'expectedPayablesRepaymentPagination',
  initialState,
  reducers: {
...
export const {
  ...
  lastPage,
  reset,
} = expectedPayablesRepaymentPaginationSlice.actions

export default expectedPayablesRepaymentPaginationSlice.reducer
