...
const branchPortfolioSummaryPaginationSlice = createSlice({
  name: 'branchPortfolioSummaryPagination',
  initialState,
  reducers: {
...
export const {
  ...
  lastPage,
  reset,
} = branchPortfolioSummaryPaginationSlice.actions

export default branchPortfolioSummaryPaginationSlice.reducer
