          ...
          <div className="bg-white rounded-lg border p-6">
            ...
            {!editInfo ? (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 text-sm">
                ...
                <div className="flex items-center gap-2"><Building size={16} className="text-gray-400" /><div><span className="text-gray-500">Type: </span><span>{detail.businessType || '-'}</span></div></div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div><label className="block text-xs font-medium text-gray-500 mb-1">Business Type</label><input value={infoForm.businessType} onChange={e => setInfoForm(p => ({ ...p, businessType: e.target.value }))} className="w-full px-3 py-2 border rounded-lg text-sm" /></div>
