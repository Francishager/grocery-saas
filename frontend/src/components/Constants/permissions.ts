...
export const permissions: Permission[] = [
  ...
  { id: 'canManageHRAttendance', name: 'Manage HR Attendance', description: 'Record, import and edit attendance', category: 'hr', accessesBusinessData: true },
  ...
  { id: 'canManageHRPayroll', name: 'Manage HR Payroll', description: 'Process and manage payroll', category: 'hr', accessesBusinessData: true },
